    ...
    return (
      ...
      <div className="main" id="section1">
          ...
          <br />
            ...
            <button className="button" onclick="window.location.href = '#section2';">
          See More</button>
          </div>
        <div className="main" id="section2">
          <h2 className="HavenText-Welcome"> Whether you are looking to <br /> hire a photographer for an event, <br />
